    ...
    >
      ...
      <div className="flex flex-col items-center">
        ...
        {index < steps.length - 1 && (
          <div className="mt-4 h-full w-px bg-gradient-to-b from-gold-500/30 to-transparent min-h-[40px]" />
        )}
      </div>
      ...
      <div className="pb-10">
        <div className="mb-1 flex flex-wrap items-center gap-3">
          <span className="font-heading text-2xl font-bold text-gold-500/40">{step.number}</span>
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {step.deliverables.map((d) => (
            <span key={d} className="flex items-center gap-1.5 rounded-full border border-gold-500/15 bg-gold-500/5 px-3 py-1 text-xs text-gold-400/70">
